package com.yjs.cloud.learning.behavior.biz.api.member;

import com.yjs.cloud.learning.behavior.biz.api.member.bean.MemberResponse;
import com.yjs.cloud.learning.behavior.common.request.service.RequestService;
...
public class MemberApi {
    ...
    public List<MemberResponse> getByIds(List<Long> ids) {
        ...
        param.put("ids", ids);
        return requestService.list("/user-center/public-api/by-ids", param, MemberResponse.class);
    }
