package com.yjs.cloud.learning.behavior.common.request.service;

import com.alibaba.fastjson.JSONObject;
import com.yjs.cloud.learning.behavior.common.config.GatewayConfig;
import com.yjs.cloud.learning.behavior.common.response.UnifiedResponse;
...
public class RequestService {
    ...
    public <T> List<T> list(String path, Map<String, Object> param, Class<T> clazz) {
        String url = gatewayConfig.getUrl() + path;
        List<T> t = null;
        try {
            UnifiedResponse unifiedResponse = requestService.get(url, param, new ParameterizedTypeReference<UnifiedResponse>() {});
            ...
            t = JSONObject.parseArray(JSONObject.toJSONString(unifiedResponse.getData()), clazz);
        } catch (Exception e) {
            log.error("request error，url: {}, param：{}", path, param, e);
        }
        return t;
